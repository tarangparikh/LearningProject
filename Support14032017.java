...
// static   int key[][]=new int[16][48];
    ...
    public static ArrayList primitiveRoot(long prime){
        
        
        ArrayList al = new ArrayList();
        
        long[][] matrix = new long[(int)prime-1][(int)prime-1];
        for(long i = 0 ; i < prime-1 ; i++){
            for(long j=0;j<prime-1;j++){
                matrix[(int)i][(int)j]=fastMod(i+1,j+1,prime);
    ...
    }    //Primitive roots of prime number
    public static ArrayList doubleOfPoint(ArrayList point1,long a,long prime){
        ArrayList al = new ArrayList();
        long lamda = ((3*(long)power((long)point1.get(0),2))+a)/(2*(long)point1.get(1));
        long x3=(power(lamda,2)-(2*(long)point1.get(0)));
        long y3=(lamda*((long)point1.get(0))-x3)-(long)point1.get(1);
        al.add(x3);
        al.add(y3);
        return al;
        
     }
    public static ArrayList additionOfPoint(ArrayList point1,ArrayList point2,long a,long prime){
        ArrayList al = new ArrayList();
        long lamda = ((3*(long)power((long)point1.get(0),2))+a)/(2*(long)point1.get(1));
        long x3=(power(lamda,2)-((long)point1.get(0)+(long)point2.get(0)));
        long y3=(lamda*((long)point1.get(0))-x3)-(long)point1.get(1);
        al.add(x3);
        al.add(y3);
        return al;
    ...
    public static int operationPoint(ArrayList point){
        int a=0;
